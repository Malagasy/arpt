...
class Arpt{
	...
	private function installation(){
		...
		elseif( $_GET['step'] == 'config' ) :
			...
			$link->query("CREATE TABLE IF NOT EXISTS `arpt_general` ( `id` int(11) NOT NULL AUTO_INCREMENT, `setting` varchar(50) NOT NULL, `value` varchar(50) NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=latin1");
