	...
	<div class="row page-header">
		...
		if( $c < 800 ){ ?>
			<div class="panel panel-default padding-10">
				Cette page ne semble pas assez complète. Si vous souhaitez obtenir des informations supplémentaires, <button type="button" class="btn btn-link" data-toggle="modal" data-target="ask">faites une demande</button>.
			</div>
